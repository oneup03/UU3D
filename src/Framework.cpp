    ...
    m_vr{std::make_shared<VR>()}
{
    ...
    // Effective process DPI awareness — per-monitor is REQUIRED for pixel-exact
...
void Framework::on_frame_d3d11() {
   ...
   /*     } else {   
    ...
    if (auto draw_data = ImGui::GetDrawData(); draw_data != nullptr) {
        ...
        // frame — the flat copy would sit on top of the stereo one.
...
void Framework::on_frame_d3d12() {
    ...
    if (auto draw_data = ImGui::GetDrawData(); draw_data != nullptr) {
        ...
        // consumed the menu RT as an in-eye layer this frame — the flat copy
